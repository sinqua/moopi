    ...
    return (
        <div>
            ...
            <div className="flex  items-center space-x-[40px]">
                <Image src={currentProfileImage ? currentProfileImage : emptyImg} width={160} height={160} className="sm:h-[160px] h-[100px] sm:w-[160px] w-[100px] bg-gray-200 rounded-full border-none" alt="" />
                <form>
