...
const FullCanvas = (props: FullCanvasProps) => {
  const { userId, filename, modelUrl, setMdoelUrl, animationUrl, setAnimationUrl, progress, setProgress, cameraActive, cameraControlsRef, resetCamera, canvasRef } = props;
